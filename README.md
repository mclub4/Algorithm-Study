...
- 본 문서는 개인적인 공부를 위해 이곳저곳에 흩어져있는 컴퓨터 관련 전공 지식을 한곳에 정리해 둔 문서임. 공부용으로 개발 관련, CS관련 등도 모아져 있지만 메인은 알고리즘/자료구조임. 그니깐 뭐가 어쨌고 딴지 ㄴㄴ
...
- 개발/CS/시사이슈 관련해서는 맨 밑에 10장에 따로 모아뒀고, 개인적인 공부에 초점을 맞춰져 있어서 원하는 내용이 없을 수도 있음.
...
### - 상한선/하한선 (Upper Bound/Lower Bound)
